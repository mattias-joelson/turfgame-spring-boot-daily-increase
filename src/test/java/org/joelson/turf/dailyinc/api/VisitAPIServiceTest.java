...
public class VisitAPIServiceTest {
    ...
    public void getVisitTest() {
        ...
        assertEquals(TAKE_ZONE_ONE_BY_USER_ONE, visitAPIService.getVisit(ZONE_ONE, USER_ONE, TIME));
        assertEquals(ASSIST_ZONE_ONE_BY_USER_TWO, visitAPIService.getVisit(ZONE_ONE, USER_TWO, TIME));
        assertEquals(REVISIT_ZONE_TWO_BY_USER_THREE, visitAPIService.getVisit(ZONE_TWO, USER_THREE, TIME));
        assertEquals(ASSIST_ZONE_TWO_BY_USER_FOUR, visitAPIService.getVisit(ZONE_TWO, USER_FOUR, TIME));
        assertEquals(TAKE_ZONE_ONE_BY_USER_THREE_LATER, visitAPIService.getVisit(ZONE_ONE, USER_THREE, TIME_LATER));
        assertEquals(TAKE_ZONE_TWO_BY_USER_FOUR_LATER, visitAPIService.getVisit(ZONE_TWO, USER_FOUR, TIME_LATER));
        assertEquals(ASSIST_ZONE_TWO_BY_USER_ONE_LATER, visitAPIService.getVisit(ZONE_TWO, USER_ONE, TIME_LATER));
        assertEquals(ASSIST_ZONE_TWO_BY_USER_TWO_LATER, visitAPIService.getVisit(ZONE_TWO, USER_TWO, TIME_LATER));
        assertNull(visitAPIService.getVisit(ZONE_ONE, USER_FIVE, TIME));
        assertNull(visitAPIService.getVisit(ZONE_TWO, USER_FIVE, TIME));
        assertNull(visitAPIService.getVisit(ZONE_ONE, USER_FIVE, TIME_LATER));
        assertNull(visitAPIService.getVisit(ZONE_THREE, USER_ONE, TIME));
        assertNull(visitAPIService.getVisit(ZONE_THREE, USER_TWO, TIME));
        assertNull(visitAPIService.getVisit(ZONE_THREE, USER_THREE, TIME));
        assertNull(visitAPIService.getVisit(ZONE_ONE, USER_ONE, TIME_LATEST));
        assertNull(visitAPIService.getVisit(ZONE_ONE, USER_TWO, TIME_LATEST));
        assertNull(visitAPIService.getVisit(ZONE_TWO, USER_THREE, TIME_LATEST));
    ...
    public void createVisitTest() {
        ...
        assertEquals(TAKE_ZONE_ONE_BY_USER_ONE, visitAPIService.create(ZONE_ONE, USER_ONE, TIME, VisitType.TAKE));
        assertEquals(ASSIST_ZONE_ONE_BY_USER_TWO, visitAPIService.create(ZONE_ONE, USER_TWO, TIME, VisitType.ASSIST));
        assertEquals(REVISIT_ZONE_TWO_BY_USER_THREE, visitAPIService.create(ZONE_TWO, USER_THREE, TIME, VisitType.REVISIT));
        assertEquals(ASSIST_ZONE_TWO_BY_USER_FOUR, visitAPIService.create(ZONE_TWO, USER_FOUR, TIME, VisitType.ASSIST));
        assertEquals(TAKE_ZONE_TWO_BY_USER_FOUR_LATER, visitAPIService.create(ZONE_TWO, USER_FOUR, TIME_LATER, VisitType.TAKE));
        assertEquals(ASSIST_ZONE_TWO_BY_USER_ONE_LATER, visitAPIService.create(ZONE_TWO, USER_ONE, TIME_LATER, VisitType.ASSIST));
        assertEquals(ASSIST_ZONE_TWO_BY_USER_TWO_LATER, visitAPIService.create(ZONE_TWO, USER_TWO, TIME_LATER, VisitType.ASSIST));
        assertEquals(TAKE_ZONE_ONE_BY_USER_THREE_LATER, visitAPIService.create(ZONE_ONE, USER_THREE, TIME_LATER, VisitType.TAKE));
