...
public interface VisitRepository extends JpaRepository<Visit, VisitId> {
    ...
    @QueryHints(@QueryHint(name = "org.hibernate.fetchSize", value = "100"))
    <T> List<T> findLastSortedReversed(int count, Class<T> type);
    ...
    @QueryHints(@QueryHint(name = "org.hibernate.fetchSize", value = "100"))
    <T> List<T> findLastSortedReversedByUser(Long userId, int count, Class<T> type);
    ...
    @QueryHints(@QueryHint(name = "org.hibernate.fetchSize", value = "100"))
    <T> List<T> findLastSortedReversedByZone(Long zoneId, int count, Class<T> type);
}
